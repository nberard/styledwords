 ...
 * @property WordInRecord[] $wordInRecords
 */
class Word extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'notations' => array(self::HAS_MANY, 'Notation', 'word_id'),
			'wordInRecords' => array(self::HAS_MANY, 'WordInRecord', 'word_id'),
		);
	}
