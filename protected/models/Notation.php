...
/**
 * This is the model class for table "notation".
 *
 * The followings are the available columns in table 'notation':
 * @property integer $id
 ...
 * @property User $user
 */
class Notation extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Notation the static model class
	 */
